                ...
                <div class="board_title">
                    ...
                    <div class="board_list_wrap">
                          ...
                          <thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="a">
                                        <a href="/boardBackEndView">백엔드 추천사이트</a>
                                    </td>
                                    <td class="c">관리자</td>
                                ...
                                <tr>
                                    <td class="b">4</td>
                                    <td class="a">
                                        <a href="/boardBackEndView">프론트 추천사이트</a>
                                    </td>
                                    <td class="c">관리자</td>
                                    <td class="d">2021-03-12</td>
                                    <td class="e">5 </td>
                                    ...
                                    <td class="b">3</td>
                                    <td class="a">
                                        <a href="/boardBackEndView">패쓰파인더</a>
                                    </td>
                                    <td class="c">코린이</td>
                                    <td class="d">2021-03-12</td>
                                    <td class="e">11 </td>
                                    ...
                                    <td class="b">2</td>
                                    <td class="a">
                                        <a href="/boardBackEndView">깃허브 사용법 공유</a>
                                    </td>
                                    <td class="c">병아리</td>
                                    <td class="d">2021-03-12</td>
                                    <td class="e">52 </td>
                                    ...
                                    <td class="b">1</td>
                                    <td class="a">
                                        <a href="/boardBackEndView">db 어렵 </a>
                                        </td>
                                    <td class="c">관리자</td>
                                    <td class="d">2021-03-12</td>
                                    <td class="e">102 </td>
                        ...
                        <div class="pagbt">
                            ...
                            <div class="bt_wrap">
                                <a href="/boardBackEndWrite" class="on">글쓰기</a>
                            </div>
                        </div>
                    </div>
                </div>
